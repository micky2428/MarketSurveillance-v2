 ...
 */
//这个活动展示了如何使用 CameraX 库的 CameraXSource 来获取相机图像，并应用机器学习模型进行实时分析。
//用户也可以在界面上选择不同的机器学习模型，但是这些模型是直接应用于相机图像的。
...
////https://github.com/googlesamples/mlkit/blob/master/android/vision-quickstart/app/src/main/java/com/google/mlkit/vision/demo/kotlin/CameraXSourceDemoActivity.kt
